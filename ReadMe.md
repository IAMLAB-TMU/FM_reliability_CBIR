...
For TMA/Slide level evaluation, leave-one-patient-out evaluation is used to go over all the data. For TMA, we used all the available patches to perform search and retrieval.<br>
